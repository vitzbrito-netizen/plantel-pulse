...
import { Users, TrendingUp, Heart, Building2, ChevronRight, Plus, LogOut, Pencil, Trash2, Loader2, Shield } from 'lucide-react';
...
import OwnerEquipeTab from '@/components/OwnerEquipeTab';
...
export default function OwnerDashboard() {
  ...
  const [activeTab, setActiveTab] = useState<'unidades' | 'equipe'>('unidades');
    ...
    <div className="min-h-screen bg-background">
      <header className="bg-card border-b border-border">
        ...
        <div className="px-6 flex gap-1">
          <TabButton active={activeTab === 'unidades'} onClick={() => setActiveTab('unidades')}>
