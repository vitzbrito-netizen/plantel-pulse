...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a 
              href="#features" 
              className="border border-border text-foreground px-8 py-3.5 rounded-lg font-semibold text-sm hover:bg-muted transition-colors inline-flex items-center justify-center gap-2"
            >
              Ver Recursos
            </a>
          </div>
      ...
      {/* FAQ */}
      <section id="faq" className="py-24 px-6 bg-muted/30 border-y border-border/50">
