...
export const employees: Employee[] = [
  {
    ...
    birthday: '1986-09-18',
    notes: 'Gerente do laboratório. Conduz rituais de cultura. Corinthians.',
  },
  {
    ...
    birthday: '1986-03-02',
    notes: 'Casado com Sabrina. 3 filhos: Kauan, João, Mellyna. Palmeiras. Quer ser analista. Especialidade: análise de urina.',
  },
  {
    ...
    birthday: '1982-06-27',
    notes: 'Corinthians. 2 filhos. Especialidade: coleta de recém-nascido. Comida favorita: pizza.',
  },
  {
    ...
    birthday: '1980-09-11',
    notes: 'Flamengo. Solteira. Comida favorita: estrogonofe.',
  },
  {
    ...
    birthday: '1998-09-16',
    notes: 'Diploma recente. Hobbies: jogos de tabuleiro, cinema, cachoeira. Ensina: paciência e empatia.',
  },
  {
    ...
    birthday: '1994-09-17',
    notes: 'Solteira. 1 filha. Academia e leitura. Conquista: carro próprio. Outback.',
  },
  {
    ...
    birthday: '1999-09-20',
    notes: 'Casada com Paulo. Filha: Mellyna (07/07/2024). Flamengo. Coco Bambu. Ensina: atendimento humanizado.',
  },
  {
    ...
    birthday: '1998-01-20',
    notes: 'Casada desde 27/06/2023. 2 filhos. Artesanato e animais. Não quer reconhecimento público. Formada.',
  },
  {
    id: '9', clientId: 'excelencia', name: 'Colaborador 09', role: 'Técnico de Laboratório', tier: 'Influente',
    ovr: 72, morale: 55, salary: 4200, contractEnd: '2026-08-31', turno: 'Noturno',
    skills: { tecnica: 74, comunicacao: 60, lideranca: 50, disciplina: 68, trabalhoEmEquipe: 55 },
    fitness: 70, form: 62, afinidades: [], tensoes: [], flightRisk: false,
  },
  {
    id: '10', clientId: 'excelencia', name: 'Colaborador 10', role: 'Recepcionista', tier: 'Influente',
    ovr: 71, morale: 82, salary: 3800, contractEnd: '2026-10-31', turno: 'Diurno',
    skills: { tecnica: 60, comunicacao: 85, lideranca: 55, disciplina: 72, trabalhoEmEquipe: 78, atendimento: 82 },
    fitness: 85, form: 80, afinidades: [], tensoes: [], flightRisk: false,
  },
  {
    id: '11', clientId: 'excelencia', name: 'Colaborador 11', role: 'Recepcionista', tier: 'Influente',
    ovr: 70, morale: 85, salary: 3200, contractEnd: '2027-01-31', turno: 'Diurno',
    skills: { tecnica: 55, comunicacao: 80, lideranca: 48, disciplina: 70, trabalhoEmEquipe: 75, atendimento: 78 },
    fitness: 82, form: 78, afinidades: [], tensoes: [], flightRisk: false,
  },
  {
    id: '12', clientId: 'excelencia', name: 'Colaborador 12', role: 'Técnico de Laboratório', tier: 'Influente',
    ovr: 69, morale: 45, salary: 5100, contractEnd: '2026-06-30', turno: 'Noturno',
    skills: { tecnica: 72, comunicacao: 55, lideranca: 45, disciplina: 65, trabalhoEmEquipe: 50 },
    fitness: 65, form: 55, afinidades: [], tensoes: [], flightRisk: true,
    notes: 'RISCO DE FUGA. Moral muito baixa, contrato vencendo.',
  },
  {
    id: '13', clientId: 'excelencia', name: 'Colaborador 13', role: 'Técnico de Laboratório Jr', tier: 'Promessa',
  ...
  {
    id: '14', clientId: 'excelencia', name: 'Colaborador 14', role: 'Técnico de Laboratório Jr', tier: 'Promessa',
  ...
  {
    id: '15', clientId: 'excelencia', name: 'Colaborador 15', role: 'Técnico de Laboratório Jr', tier: 'Promessa',
    ovr: 61, morale: 88, salary: 3000, contractEnd: '2027-06-30', turno: 'Diurno',
  ...
  },
  {
    ...
    ovr: 58, morale: 90, salary: 2800, contractEnd: '2026-09-30', turno: 'Diurno',
